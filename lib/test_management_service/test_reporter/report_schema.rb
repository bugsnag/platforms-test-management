...
module TestManagementService
  module TestReports
    class Report
      ...
      has_one :configuration, class_name: 'Configuration', inverse_of: :report
      has_one :build, class_name: 'Build', inverse_of: :report
      has_many :session, class_name: 'Session', inverse_of: :report
